...
namespace AutoScript.Share
{
    ...
    public interface Idmsoft
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        [DispId(111)]
        int ReadInt([In] int hwnd, [In][MarshalAs(UnmanagedType.BStr)] string addr, [In] int type);
        ...
        [DispId(114)]
        [return: MarshalAs(UnmanagedType.BStr)]
        string FindInt([In] int hwnd, [In][MarshalAs(UnmanagedType.BStr)] string addr_range, [In] int int_value_min, [In] int int_value_max, [In] int type);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        [DispId(118)]
        int GetModuleBaseAddr([In] int hwnd, [In][MarshalAs(UnmanagedType.BStr)] string module_name);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        [DispId(124)]
        int WriteInt([In] int hwnd, [In][MarshalAs(UnmanagedType.BStr)] string addr, [In] int type, [In] int v);
        ...
        [DispId(244)]
        [return: MarshalAs(UnmanagedType.BStr)]
        string FindIntEx([In] int hwnd, [In][MarshalAs(UnmanagedType.BStr)] string addr_range, [In] int int_value_min, [In] int int_value_max, [In] int type, [In] int step, [In] int multi_thread, [In] int mode);
